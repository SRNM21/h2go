								...
								<div class='p-4 overflow-auto w-100 tab-content'>
									...
									<div class='tab-pane fade show active' id='nav-profile' role='tabpanel' aria-labelledby='nav-details' tabindex='0'>
                                        ...
                                        <form id='profile-form' class='needs-validation' novalidate='true'>
                                            ...
                                            <div class='mb-4 has-validation'>
                                                ...
                                                <select id='cs-gender' class='form-select' aria-label='Select Gender' data-fb='Gender' data-initial='{$customer/personal-details/gender}' required='true' disabled='true'>
									...
									<div class='tab-pane fade' id='nav-account' role='tabpanel' aria-labelledby='nav-account' tabindex='0'>
										...
										<form id='account-form' class='needs-validation' novalidate='true'>
											<div class='mb-3 has-validation'>
												<label for='cs-email' class='form-label'>Email</label>
												<input type='email' id='cs-email' class='form-control' data-fb='Email' disabled='true' value='{$customer/account-details/email}' data-initial='{$customer/account-details/email}'/>
                                                <div id='cs-email-invalid-fb' class='invalid-feedback'></div>
											</div>
						...
						<div class='modal-content'>
							...
							<div id='change-pass-modal-content' class='modal-body'>
								<form id='change-password-form' class='needs-validation' novalidate='true'>
									<div class='mb-3 has-validation'>
										<label for='cs-change-password' class='form-label'>Password</label>
										<input id='cs-change-password' type='password' aria-label='Password' class='form-control' data-fb='Password' required='true'/>    
										<div id='cs-change-password-invalid-fb' class='invalid-feedback'></div>
									</div>
									<div class='mb-3 has-validation'>
										<label for='cs-confirm-change-password' class='form-label'>Confirm Password</label>
										<input id='cs-confirm-change-password' type='password' aria-label='Confirm Password' class='form-control' data-fb='Confirm Password' required='true'/>    
										<div id='cs-confirm-change-password-invalid-fb' class='invalid-feedback'></div>
									</div>
								...
								<div class='mt-4'>
									<form id='deletion-form' class='needs-validation' novalidate='true'>
										...
										<div class='mb-3 has-validation'>
											...
											<input id='del-pass' type='password' aria-label='Password' class='form-control' data-fb='Password' required='true' data-compare='{$customer/account-details/password}'/>
				...
				<div id='deletion-success-modal' class='modal fade' tabindex='-1' aria-labelledby='deletion-success-modal-label' aria-hidden='true' data-bs-backdrop='static' data-bs-keyboard='false'>
                    <div class='modal-dialog modal-dialog-centered'>
                        <div class='modal-content'>
                            ...
                            <div class='modal-footer'>
                                <a href='../auth/cs_sign_in.html' class='btn btn-primary primary-modal-btn'>Confirm</a>
                            </div>
                        </div>
                    </div>
                </div>
