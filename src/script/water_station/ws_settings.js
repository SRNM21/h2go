...
import { notify } from "../../util/helper.js";
...
discardChangesBtn.on("click", function () {
  if (CURRENT_EDIT == "EMAIL") {
    resetEmailUtilBtns(emailInput.data("initial"));
  } else if ((CURRENT_EDIT = "EDIT WATER STATION DETAILS")) {
...
saveEmailEditBtn.on("click", () => {
  CURRENT_EDIT = "EMAIL";
});
changePassBtn.on("click", () => {
  CURRENT_EDIT = "PASSWORD";
});
...
verifyBtn.on("click", function () {
  ...
  } else if (CURRENT_EDIT == "PASSWORD") {
    changePassModal.modal("toggle");
  } else if (CURRENT_EDIT == "WATER STATION DETAILS") {
